...
document.querySelector("#currentDate").innerHTML = `&copy; ${year} | Bryant W. Taylor | Utah`
document.querySelector("#lastUpdate").innerHTML = `Last updated: ${upmonth}/${upday}/${upyear} ${uphour}:${upminutes}:${upseconds}`
